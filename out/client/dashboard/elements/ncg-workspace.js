...
`;
    ...
    startObservingPanelMutations() {
        ...
        try {
            ...
            this['_panelMutationObserver'] = new MutationObserver(() => {
                this['_handleMutationDebounce'] = Debouncer.debounce(this['_handleMutationDebounce'], timeOut.after(150), this._debouncedMutationHandler.bind(this));
            });
    ...
    initPackery() {
        ...
        if (rawStoredSortOrder) {
            const storedSortOrder = JSON.parse(rawStoredSortOrder);
    ...
    _routeChanged(route) {
        if (this['usePackery']) {
            ...
            if (route.path === this.parentNode.route) {
                this['_fixPackeryDebounce'] = Debouncer.debounce(this['_fixPackeryDebounce'], timeOut.after(10), this._fixPackery.bind(this));
            }
        }
    }
...
//# sourceMappingURL=ncg-workspace.js.map