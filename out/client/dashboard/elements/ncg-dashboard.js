...
`;
    ...
    static get properties() {
        ...
        return {
            ...
            loginDisabled: {
                type: Boolean,
                value: !((_a = window.ncgConfig.login) === null || _a === void 0 ? void 0 : _a.enabled),
            },
            bundles: {
                type: Array,
            ...
            pages: {
                ...
                value() {
                    ...
                    if ((_a = window.ncgConfig.login) === null || _a === void 0 ? void 0 : _a.enabled) {
                        pages.push({
                            name: 'Settings',
                            route: 'settings',
                            icon: 'settings',
...
//# sourceMappingURL=ncg-dashboard.js.map